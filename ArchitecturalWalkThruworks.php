...
<h1 class="wow fadeInDownBig">Architectural WalkThruworks</h1>

<div class="row mediawork">
<?php
                              $counter = 0;
                              $courses = $db->getRows("SELECT * from students_works_architechtural order by architechtural_id desc");
                              if( count($courses) > 0){
                                foreach($courses as $data){ 
								  $design_id = $data["architechtural_id"];
                                  $architechtural_name = $data["architechtural_name"];
                                  $video = $data["architechtural_file"];  
                                  $counter++;
