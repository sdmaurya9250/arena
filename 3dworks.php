...
<h1 class="wow fadeInDownBig">3D Animation</h1>
<div class="row mediawork">
<?php
                              $counter = 0;
                              $courses = $db->getRows("SELECT * from students_works_3d_animations order by animations_id desc");
                              if( count($courses) > 0){
