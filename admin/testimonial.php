...
if (isset($_POST['update'])) {
    ...
    //   $rest = $db->insertAry('testimonials',$create);
      $rest = $db->updateAry("testimonials", $create, "where test_id=".$_GET['test_id']);
                    }
                  }
      // echo $db->getLastquery();
      // exit();
  ...
  <form name="add_video" id="add_post_form" class="form-horizontal" enctype="multipart/form-data"  role="form" method="post">
    ...
    <div class="panel-body" style="margin-top:0px;">
          ...
          <div class="row">
             ...
             <div class="col-md-4 mgt-20">
                   <label>Status</label>
             <input type="text" name="test_status" class="form-control" placeholder="Status"  >
             </div>
             <div class="col-md-4 mgt-20">
        ...
        <div class="panel-default">
              ...
              <table width="100%" class="table table-bordered table-striped table-hover" id="dataTables-example">
                <thead>
                  <tr>
                    ...
                    <th>Images</th> 
                    <th>Descriptions</th>
                    <th>Background Information Status</th> 
                ...
                <tbody>
                  <?php
                        ...
                        $counter = 0;
                        $courses = $db->getRows("SELECT * from testimonials order by test_id desc ");
                        if( count($courses) > 0){
         ...
         ?>
                        <tr class="odd gradeX">
                          ...
                          <?php $values=''; if(strpos($test_img, "http") !== false){ $values= $test_img; } else if($test_img !=''){ $values= '../'.$test_img; } ?>

                          <td><img src='<?=$values?>' style='max-width: 100px;'/></td>
                          <td><?php echo $descriptions ?></td>
                          <td><p>---</p><?php echo $test_status ?></td>
                                                                             
                          
                          <td class="text-center ac_user_edit">
                                    <button class="123 btn btn-primary btn-circle  TestimonialsEditStatus" style="background: #2b3252;" data-toggle="modal" data-target="#myModal" name="edit" data-id="<?php echo $id; ?>" data-myvalue="<?php echo $id; ?>" ><i class="fa fa-pencil-alt"></i>
                                  </button>
                            </td>
