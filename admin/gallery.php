  ...
  if (isset($_POST['submit'])) {
    ...
    if (isset($_FILES['image']['name'][$i])) {   
      ...
      $create = array(
                          ...
                          'image' => $filename, 
                          'gallery_name' =>  $_POST["title"],
                          
                                                 
                         
                      );
      $rest = $db->insertAry('gallery',$create);
                    }
                  }
...
<div id="page-wrapper">
  ...
  <div class="row panel panel-default mgt-20"  >
    <div class="panel-heading">
      <h1 class="white-text page-heading">Gallery</h1>
    </div>
         ...
         ?>
                        <tr class="odd gradeX">
                          ...
                          <td class="text-center ac_user_edit">
                                    <button class="123 btn btn-primary btn-circle  GalleryEditStatus" style="background: #2b3252;" data-toggle="modal" data-target="#myModal" name="edit" data-id="<?php echo $id; ?>" data-myvalue="<?php echo $id; ?>" ><i class="fa fa-pencil-alt"></i>
                                  </button>
                            </td>
                          <td class="text-center ac_course_delete">
                            <button type="button" id="gallery_delete" onclick="DeleteConfirmation(this,'gallery')" name="gallery_delete" value="<?php  echo $id ?>" class="btn btn-danger btn-circle"><i class="fa fa-times"></i>
                            </button>
                          </td>
                        </tr>
              ...
              Okay: {
                ...
                action: function(){
                  $.ajax({
                    type: 'post',
                    url: 'ajax.php',
                    data: 'action=Gallery_delete&Id='+id+'&gallery_delete='+tablename,
                    dataType: "json",
