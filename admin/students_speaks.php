  ...
  if (isset($_POST['submit'])) {
    ...
    if (isset($_FILES['image']['name'][$i])) {   
      ...
      if (in_array($ext, array('jpeg', 'jpg', 'gif', 'png','webp'))) {
          ...
          if (move_uploaded_file($_FILES['image']['tmp_name'][$i], '../img/'.$newfile)){
            $filename = 'img/'.$newfile;                
          }
      } 
      else {
          $filename = "";
      ...
      $create = array(
                          ...
                          'images' => $filename, 
                          'speaks_name' =>  $_POST["speaks_name"],
                          'speaks_company' =>  $_POST["speaks_company"],
                          'speaks_designation' =>  $_POST["speaks_designation"], 
                          'students_email' =>  $_POST["students_email"],                       
                         
                      );
      $rest = $db->insertAry('students_speaks',$create);
                    }
                  }
      ...
      if(!is_null($rest)){
        ...
        echo "<script>window.location.href='students_speaks.php';</script>";
      }else{ 
...
<div id="page-wrapper">
  ...
  <div class="row panel panel-default mgt-20"  >
    <div class="panel-heading">
      <h1 class="white-text page-heading">Students Speaks</h1>
    </div>
  ...
  <form name="add_video" id="add_post_form" class="form-horizontal" enctype="multipart/form-data"  role="form" method="post">
    ...
    <div class="panel-body" style="margin-top:0px;">
          ...
          <div class="row">
             ...
             <input type="text" name="speaks_name" class="form-control" placeholder="Student Name"  >
             </div>
             <div class="col-md-4 mgt-20">
             ...
             <div class="col-md-4 mgt-20">
                   <label>Students Speaks Company</label>
             <input type="text" name="speaks_company" class="form-control" placeholder="Students Speaks Company"  >
             </div>
             <div class="col-md-4 mgt-20">
                   <label>Students Email</label>
             <input type="text" name="students_email" class="form-control" placeholder="Students Email"  >
             </div>
             <div class="col-md-4 mgt-20">
                   <label>Students Speaks Designation</label>
             <textarea type="text" name="speaks_designation" class="form-control" placeholder="Students Speaks Designation"  ></textarea>
             </div>
        ...
        <div class="panel-default">
              ...
              <table width="100%" class="table table-bordered table-striped table-hover" id="dataTables-example">
                <thead>
                  <tr>
                    ...
                    <th>Name</th>      
                    <th>Images</th> 
                    <th>Students Speaks Company</th>
                    <th>Students Speaks Designation</th> 
         ...
         ?>
                        <tr class="odd gradeX">
                          ...
                          <?php $values=''; if(strpos($images, "http") !== false){ $values= $images; } else if($images !=''){ $values= '../'.$images; } ?>
                          ...
                          <td class="text-center ac_course_delete">
                            <button type="button" id="test_delete" onclick="DeleteConfirmation(this,'testimonials')" name="test_delete" value="<?php  echo $id ?>" class="btn btn-danger btn-circle"><i class="fa fa-times"></i>
                            </button>
                          </td>
                        </tr>
...
$(document).on("click", ".TestimonialsEditStatus", function(event) {
		event.preventDefault();
		var value = $(this).attr('data-id');
		$.ajax({
				url: 'ajax.php',
				type: 'POST',
				data: 'action=Testimonials_Edit&id=' + value,
				dataType: 'html'
			})
			.done(function(data) {
				// console.log(data);  
              ...
              Okay: {
                ...
                action: function(){
                  $.ajax({
                    type: 'post',
                    url: 'ajax.php',
                    data: 'action=testimonials_part_delete&Id='+id+'&test_delete='+tablename,
                    dataType: "json",
