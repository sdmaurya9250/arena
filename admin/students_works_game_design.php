  ...
  if (isset($_POST['submit'])) {
    ...
    if (isset($_FILES['image']['name'][$i])) {   
      ...
      if (in_array($ext, array('jpeg', 'jpg', 'gif', 'png','webp'))) {
          ...
          if (move_uploaded_file($_FILES['image']['tmp_name'][$i], '../images/student_work_gaming/'.$newfile)){
            $filename = 'images/student_work_gaming/'.$newfile;                
          }
      } 
      else {
          $filename = "";
      ...
      $rest = $db->insertAry('students_works_gaming',$create);
                    }
                  }
      ...
      if(!is_null($rest)){
        ...
        echo "<script>window.location.href='students_works_game_design.php';</script>";
      }else{ 
...
if (isset($_POST['update'])) {
    ...
    //   $rest = $db->insertAry('testimonials',$create);
      $rest = $db->updateAry("students_works_gaming", $create, "where gaming_id='".$_POST['gaming_id']."'");
...
<div id="page-wrapper">
  ...
  <div class="row panel panel-default mgt-20"  >
    <div class="panel-heading">
      <h1 class="white-text page-heading">Students Works Gaming Design</h1>
    </div>
         ...
         ?>
                        <tr class="odd gradeX">
                          ...
                          <td class="text-center ac_course_delete">
                            <button type="button" id="gaming_delete" onclick="DeleteConfirmation(this,'students_works_gaming')" name="gaming_delete" value="<?php  echo $id ?>" class="btn btn-danger btn-circle"><i class="fa fa-times"></i>
                            </button>
                          </td>
                        </tr>
              ...
              Okay: {
                ...
                action: function(){
                  $.ajax({
                    type: 'post',
                    url: 'ajax.php',
                    data: 'action=Gaming_delete&Id='+id+'&gaming_delete='+tablename,
                    dataType: "json",
