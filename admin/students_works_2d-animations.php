...
$embedTexts = preg_replace("/\s*[a-zA-Z\/\/:\.]*youtube.com\/watch\?v=([a-zA-Z0-9\-_]+)([a-zA-Z0-9\/\*\-\_\?\&\;\%\=\.]*)/i","<iframe width=\"240\" height=\"240\" src=\"//www.youtube.com/embed/$1\" frameborder=\"0\" allowfullscreen></iframe>",$texts);
    ...
    $sql="SELECT * FROM students_works_2d_animations";
    $result = $db->query($sql);
...
$video_title = $_POST["video_title"];
 ...
 $sql = "INSERT INTO `students_works_2d_animations`(`animations_file`,`animations_name`)VALUES ('$embedTexts','$video_title')";
        if ($db->query($sql) === TRUE) 
        {
          echo "<script>alert('Added successfully')</script>";
          echo "<script>window.location.href='students_works_2d-animations.php';</script>";
        } 
        else 
        {
...
<div id="page-wrapper">
  ...
  <div class="row panel panel-default mgt-20"  >
    <div class="panel-heading">
      <h1 class="white-text page-heading">Students Works 2D Animations</h1>
    </div>
              ...
              <table width="100%" class="table table-bordered table-striped table-hover" id="dataTables-example">
                ...
                <tbody>
                  <?php
                        ...
                        $counter = 0;
                        $students_works = $db->getRows("SELECT * from students_works_2d_animations order by animations_id desc");
         ...
         ?>
                        <tr class="odd gradeX">
                          ...
                          <td class="text-center ac_course_delete">
                            <button type="button" id="students_worksdelete" onclick="DeleteConfirmation(this,'students_works_2d_animations')" name="students_worksdelete" value="<?php  echo $animations_id ?>" class="btn btn-danger btn-circle"><i class="fa fa-times"></i>
                            </button>
                          </td>
                        </tr>
              ...
              Okay: {
                ...
                action: function(){
                  $.ajax({
                    type: 'post',
                    url: 'ajax.php',
                    data: 'action=Students_Worksdelete&Id='+id+'&students_worksdelete='+tablename,
                    dataType: "json",
