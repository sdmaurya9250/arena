...
<style>
  ...
  @media (min-width: 567px) and (max-width: 680px) {
    body {
  ...
  <div id="maincontappl">
    <div class="row">
      ...
      <div class="col-md-3 col-sm-3 col-xs-6 wow fadeInDown"><a href="students_speak.php"
          class="icon-bansplace studspeaksmain">Students Speaks</a></div>
...
<div class="container" id="download_documents">
  ...
  <h1 class="wow fadeInUp fadeInh1">Download PDF</h1>
  <div class="row">
    <?php
    $counter = 0;
      ...
      foreach ($courses as $data) {
        ...
        <div class="col-md-3">
          ...
          <div class="brdmrgin wow fadeInLeft">
            <div class="downldconthedpg">
              <?php echo ($pdf_title) ?>
            </div>
            <img class="img-responsive" src='<?= $imagefiles ?>' alt="" style="height:161px;">
            <button onclick="location.href='apply.php'" class="downbtnapply hvr-sweep-to-rightss" type="button">Apply
              Now</button>
            ...
            if (count($getfile) > 0) {
              $var++;
              ?>
              <button onclick="window.open('<?php echo $pdf_file ?>')" class="downbtndownldpg hvr-sweep-to-right"
      ...
      <div class="modal-body">
        <form action="" method="post">
          ...
          <div class="form-group">
            ...
            <input class="form-contol" type="hidden" id="verified" type="verified" value="yes" name="verified" hidden=""
              style="display: none;">
            <input class="form-contol" type="hidden" id="rest_id" type="verified" value="" name="apply_status_id"
