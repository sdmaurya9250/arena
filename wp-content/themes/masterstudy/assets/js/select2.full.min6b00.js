        ...
        !function (b) {
          ...
          function f(a, b) {
            var c,
                ...
                l,
                m,
                n = b && b.split("index.html"),
                o = s.map,
                p = o && o["*"] || {};
            if (a && "." === a.charAt(0)) if (b) {
              for (n = n.slice(0, n.length - 1), a = a.split("index.html"), g = a.length - 1, s.nodeIdCompat && w.test(a[g]) && (a[g] = a[g].replace(w, "")), a = n.concat(a), k = 0; k < a.length; k += 1) {
            ...
            if ((n || p) && o) {
              for (c = a.split("index.html"), k = c.length; k > 0; k -= 1) {
                if (d = c.slice(0, k).join("index.html"), n) for (l = n.length; l > 0; l -= 1) {
                  if (e = o[n.slice(0, l).join("index.html")], e && (e = e[d])) {
                    f = e, h = k;
                    break;
                  }
                }
              ...
              !f && i && (f = i, h = j), f && (c.splice(0, h, f), a = c.join("index.html"));
            }
