...
<!-- Mirrored from arenajayanagar.com/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 04 Dec 2023 11:34:11 GMT -->

<head>
  <meta name="facebook-domain-verification" content="8diu2nx6dtymldos4nv3udhrffvpwh">
  <meta name="google-site-verification" content="Mv1g4G0nyQx-m_4_EgotVoA3L-3-2DAn0DHKVspOHys">
  <meta name="DC.title" content="Arena Banashankari Animation and Designing Institute" />
  <meta name="geo.region" content="IN-KA" />
  <meta name="geo.placename" content="Bangalore" />
  <meta name="geo.position" content="22.351115;78.667743" />
  <meta name="ICBM" content="22.351115, 78.667743" />
  <!-- Global site tag (gtag.js) - Google Analytics -->
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-YTYZL6GHJK"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag() { dataLayer.push(arguments); }
    gtag('js', new Date());
    gtag('config', 'G-YTYZL6GHJK');
  </script>
  <!-- Google Tag Manager -->
  <script>(function (w, d, s, l, i) {
    ...
    })(window, document, 'script', 'dataLayer', 'GTM-WCH47D4');</script>
  <!-- End Google Tag Manager -->

  <!-- Global site tag (gtag.js) - Google Ads: 701296381 -->
  <script async src="https://www.googletagmanager.com/gtag/js?id=AW-701296381"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag() { dataLayer.push(arguments); }
    gtag('js', new Date());

    gtag('config', 'AW-701296381');

  </script>
  <script>
    var url = window.location.pathname;
    var string = 'index-2.html';
  ...
  <script>
    gtag('event', 'conversion', { 'send_to': 'AW-701296381/YExxCPiL_7ABEP3ds84C' });
  </script>
  ...
  <script type="application/ld+json">
{
  ...
  "name": "Arena Banashankari",
  "alternateName": "Arena Animation and Designing Institute",
  "url": "https://arenajayanagar.com/",
  "contactPoint": [{
    "@type": "ContactPoint",
    "telephone": "09341228440",
  ...
  "sameAs": "https://arenajayanagar.com/"
}
</script>
  ...
  <script type="application/ld+json">
{
  ...
  "potentialAction": {
    "@type": "SearchAction",
    "target": "https://arenajayanagar.com/apply.php{search_term_string}",
  ...
  <style>
    * {
    ...
    .pgdm_green .thumb-fluids:after {
      background-color: #eaeaea;
      left: auto;
      right: -4px;
    }

    .pgdmThumbs .pgdm_absolutes {
      position: absolute;
      z-index: 999;
      padding-top: 35px;
      padding-left: 35px;
    ...
    .pgmarkeing__section {
      background-image: url(images/pgdmbg.jpg);
      background-size: 100%;
      background-repeat: no-repeat;
      background-position: top left;
      background-color: #363e9c;
      background-blend-mode: multiply;
      z-index: 0;
    }

    .pgdm_green .thumb-fluid:after {
    ...
    .pgdm__section.humanbg {
      background-color: #eaeaea;
    }

    .pgdm__section.bankingBg {
      background-image: url(images/bankingBg.html);
      background-size: 100%;
      background-repeat: no-repeat;
      background-position: top left;
      background-color: #66ae37;
    ...
    .logo {
      ...
      left: 20px;
      z-index: 101;
      background-image: url(images/brand-new.jpg);
      background-repeat: no-repeat;
      width: 109px;
      height: 90px
    }
    ...
    .flashnewswrp {
      background-color: #1e1e1e;
      border-right: solid 20px #ffc504;
      border-left: solid 20px #ffc504;
      margin-top: 2px;
      margin-bottom: 20px;
      padding: 10px
    }
    ...
    .studbg {
      background-image: url(images/stud_bg.jpg);
    }
    ...
    .studwrkswrp {
      ...
      border-top: solid 5px #ffc504;
      border-bottom: solid 5px #ffc504;
      margin: 0 auto;
      position: absolute;
      top: 0px;
      padding: 3% 5% 3% 5%;
    ...
    @media only screen and (max-width:800px) {
      ...
      .flashnewswrp {
        padding: 8px;
        border-right: solid 10px #ffc504;
        border-left: solid 10px #ffc504
      }
    ...
    @media only screen and (max-width:768px) {
      ...
      .logo {
        ...
        left: 10px;
        z-index: 101;
        background-image: url(images/mob-brand.jpg);
        background-repeat: no-repeat;
        width: 90px;
        height: 74px
      }
 ...
 */
  ...
  <script>
    !function (t) { "use strict"; for (var e = [{ str: navigator.userAgent, sub: "Chrome", ver: "Chrome", name: "chrome" }, { str: navigator.vendor, sub: "Apple", ver: "Version", name: "safari" }, { prop: window.opera, ver: "Opera", name: "opera" }, { str: navigator.userAgent, sub: "Firefox", ver: "Firefox", name: "firefox" }, { str: navigator.userAgent, sub: "MSIE", ver: "MSIE", name: "ie" }], r = function (t, r) { var i = t.indexOf(e[r].ver); return -1 !== i ? parseInt(t.substring(i + e[r].ver.length + 1), 10) : "" }, i = t("html"), s = 0; s < e.length; s++)if (e[s].str && -1 !== e[s].str.indexOf(e[s].sub) || e[s].prop) { i.addClass(e[s].name + " " + e[s].name + r(navigator.userAgent, s) || r(navigator.appVersion, s)); break } i.addClass("desktop") }(jQuery), jQuery(function (t) { "use strict"; var e, r, i, s, n; if (t.browser.msie && 9 === parseInt(t.browser.version, 10)) { var a = function (t, e, r, i) { i || (i = !1); var s = t.indexOf(e); if (-1 !== s) { s += e.length; var n = i ? t.lastIndexOf(r) : t.indexOf(r, s); if (-1 !== n && n > s) return t.substr(s, n - s) } return "" }, o = function (t, e, r) { e || (e = ","), r || (r = "()"); var i = 0, s = 0, n = []; if (r.lenght < 2) return n; for (var a = 0; a < t.length;) { var o = t[a]; o === r[0] && i++, o === r[1] && i--, o === e && i < 1 && (n.push(t.substr(s, a - s)), s = a + e.length), a++ } return n.push(t.substr(s, a - s)), n }, l = function (t) { for (var e = Number(t).toString(16); e.length < 2;)e = "0" + e; return e }; for (e = 0; e < document.styleSheets.length; e++) { var c = document.styleSheets[e], u = [c]; for (r = 0; r < c.imports.length; r++)u.push(c.imports[r]); for (r = 0; r < u.length; r++) { c = u[r]; var d = []; for (i = 0; i < c.rules.length; i++) { var h = c.rules[i].cssText || c.rules[i].style.cssText; if (h) { var f = a(h, "-svg-background:", ";"); if ("" !== f) { var v = o(f); for (s = 0; s < v.length; s++) { var p = a(v[s], "linear-gradient(", ")", !0); if ("" !== p) { var g = o(p); if (!(g.length < 3)) { var m = 0, w = []; for (n = 1; n < g.length; n++) { var b = o(t.trim(g[n]), " "); if (!(b.length < 2)) { var x = t.trim(b[0]), y = 1, C = a(x, "rgba(", ")", !0), k = t.trim(b[1]); if ("" !== C) { var j = C.split(","); if (j.length < 4) continue; x = "#" + l(j[0]) + l(j[1]) + l(j[2]), y = j[3] } var I = -1 !== k.indexOf("px"); I && (m = Math.max(m, parseInt(k, 10) || 0)), w.push({ offset: k, color: x, opacity: y, isPx: I }) } } var Q = "", T = null; for (n = 0; n < w.length; n++)w[n].isPx && (w[n].offset = (parseInt(w[n].offset, 10) || 0) / (m / 100) + "%"), Q += '<stop offset="' + w[n].offset + '" stop-color="' + w[n].color + '" stop-opacity="' + w[n].opacity + '"/>', n === w.length - 1 && (T = w[n]); var z = "left" === t.trim(g[0]), S = 'x1="0%" y1="0%" ' + (z ? 'x2="100%" y2="0%"' : 'x2="0%" y2="100%"'), O = "100%"; m > 0 && (O = m + "px"); var M = z ? 'width="' + O + '" height="100%"' : 'width="100%" height="' + O + '"', D = ""; null !== T && m > 0 && (D = "<rect " + (z ? 'x="' + m + '" y="0"' : 'x="0" y="' + m + '"') + ' width="100%" height="100%" style="fill:' + T.color + ";opacity:" + T.opacity + ';"/>'); var B = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none"><linearGradient id="g" gradientUnits="objectBoundingBox" ' + S + ">" + Q + '</linearGradient><rect x="0" y="0" ' + M + ' fill="url(#g)" />' + D + "</svg>"; v[s] = v[s].replace("linear-gradient(" + p + ")", "url(data:image/svg+xml," + escape(B) + ")") } } } d.push({ s: c.rules[i].selectorText, v: "background: " + v.join(",") }) } } } for (i = 0; i < d.length; i++)c.addRule(d[i].s, d[i].v) } } } }), jQuery(function (t) { "use strict"; !t.browser.msie || t.browser.version > 8 || t(".art-slider .art-slide-item").each(function () { var e = t(this).css("background-image").replace(/"/g, "").replace(/%20/g, "").split(/\s*,\s*/); e.length > 1 && t(this).css("background-image", e[e.length - 1]) }) }), jQuery(function (t) { "use strict"; !t.browser.msie || t.browser.version > 8 || (t(".art-shapes").css("z-index", 1), !t.browser.msie || t.browser.version > 7 || t(".art-textblock > div").each(function () { var e = t(this), r = e.css("vertical-align") ? e.css("vertical-align") : "top"; if ("middle" === r) { var i = e.wrap("<div/>").parent(); e.css({ position: "relative", top: "-50%", height: "auto" }), i.css({ position: "absolute", top: "50%" }) } else "bottom" === r && e.css({ position: "absolute", height: "auto", bottom: 0 }) })) }), jQuery(function (t) { "use strict"; t("iframe[src]").each(function () { var e = t(this), r = e.attr("src"); "" != r && (-1 !== r.lastIndexOf("?") ? r += "&amp;wmode=transparent" : r += "?wmode=transparent", e.attr("src", r)) }) }), jQuery(function (t) { "use strict"; t(window).bind("resize", function () { navigatorResizeHandler(t("html").hasClass("responsive")) }) }); var navigatorResizeHandler = function (t) { "use strict"; return function (e) { e || t(".art-slider").each(function () { var e = t(this), r = e.width(), i = e.siblings(".art-slidenavigator"); if (i.length) { var s = i.attr("data-left"), n = r - r * parseFloat(s) / 100 - i.outerWidth(!1); n < 0 && i.css("margin-left", n) } }) } }(jQuery); jQuery(window).bind("resize", function (t) { "use strict"; return function () { if ("undefined" == typeof responsiveDesign || !responsiveDesign.isResponsive) { var e = t(".art-sheet").offset().left; t("header.art-header #art-flash-area").each(function () { t(this).css("left", e + "px") }) } } }(jQuery)), jQuery(function (t) { "use strict"; t("nav.art-nav").addClass("desktop-nav") }), jQuery(function (t) { "use strict"; !t.browser.msie || parseInt(t.browser.version, 10) > 7 || t("ul.art-hmenu>li:not(:first-child)").each(function () { t(this).prepend('<span class="art-hmenu-separator"> </span>') }) }), jQuery(function (t) { "use strict"; t("ul.art-hmenu a:not([href])").attr("href", "#").click(function (t) { t.preventDefault() }) }), jQuery(function (t) { "use strict"; t.browser.msie && (parseInt(t.browser.version, 10) > 7 || t.each(t("ul.art-hmenu ul"), function () { var e = 0, r = t(this), i = null; if (t.each(r.children("li").children("a"), function () { var r = (i = t(this)).outerWidth(!1); e < r && (e = r) }), null !== i) { var s = parseInt(i.css("border-left-width"), 10) || 0, n = parseInt(i.css("border-right-width"), 10) || 0, a = parseInt(i.css("padding-left"), 10) || 0, o = parseInt(i.css("padding-right"), 10) || 0; e -= s + n + a + o, r.children("li").children("a").css("width", e + "px") } })) }), jQuery(function () { "use strict"; setHMenuOpenDirection({ container: "div.art-sheet", defaultContainer: "#art-main", menuClass: "art-hmenu", leftToRightClass: "art-hmenu-left-to-right", rightToLeftClass: "art-hmenu-right-to-left" }) }); var setHMenuOpenDirection = function (t) { "use strict"; return function (e) { var r = t(e.defaultContainer); r = r.length > 0 ? r = t(r[0]) : null, t("ul." + e.menuClass + ">li>ul").each(function () { var i = t(this), s = i.outerWidth(!1), n = i.offset().left, a = i.parents(e.container), o = (a = a.length > 0 ? a = t(a[0]) : null) || r; if (null !== o) { var l = o.offset().left; n + s >= l + o.outerWidth(!1) ? i.addClass(e.rightToLeftClass).find("ul").addClass(e.rightToLeftClass) : n <= l && i.addClass(e.leftToRightClass).find("ul").addClass(e.leftToRightClass) } }) } }(jQuery), menuExtendedCreate = function (t) { "use strict"; return function () { var e = t(".art-sheet"); e.offset().left, e.width(); t(".art-hmenu>li").each(function (e, r) { var i = t(this), s = i.children("ul"); if (0 !== s.length) { i.removeClass("ext ext-r ext-l"), i.css("width", "").find(".ext-off,.ext-m,.ext-l,.ext-r").remove(), s.children("li").children("a").css("width", ""); var n = 0, a = 0; if (void 0 !== s.attr("data-ext-l") && void 0 !== s.attr("data-ext-r")) n = parseInt(s.attr("data-ext-l"), 10) + 0, a = parseInt(s.attr("data-ext-r"), 10) + 0, i.addClass("ext-r").addClass("ext-l"); else { var o = !s.hasClass("art-hmenu-right-to-left"); i.addClass(o ? "ext-r" : "ext-l") } if (s.length > 0) { var l = i.children("a"), c = l.outerWidth(!1); i.css("width", Math.round(parseFloat(c, 10)) + "px"); var u = s.width() + 0 + 2 + 2, d = u - c; if (t('<div class="ext-m"></div>').insertBefore(l), d < 0) { var h = s.children("li").children("a"), f = parseInt(h.css("padding-left").replace("px", ""), 10) || 0, v = parseInt(h.css("padding-right").replace("px", ""), 10) || 0, p = parseInt(h.css("border-left").replace("px", ""), 10) || 0, g = parseInt(h.css("border-right").replace("px", ""), 10) || 0; s.children("li").children("a").css("width", c - f - v - p - g + "px"), d = (u = s.width() + 0 + 2 + 2) - c } t('<div class="ext-l" style="width: ' + (n > 0 ? n : Math.round(parseFloat(d, 10))) + 'px;"></div>').insertBefore(l), t('<div class="ext-r" style="width: ' + (a > 0 ? a : Math.round(parseFloat(d, 10))) + 'px;"></div>').insertBefore(l), i.addClass("ext") } } }) } }(jQuery); jQuery(window).load(menuExtendedCreate), jQuery(function (t) { "use strict"; t.browser.msie && parseInt(t.browser.version, 10) < 8 && t(window).bind("resize", function () { var e = t("div.art-content"), r = e.parent().children(".art-layout-cell:not(.art-content)"), i = 0; e.hide(), r.each(function () { i += t(this).outerWidth(!0) }), e.w = e.parent().width(), e.css("width", e.w - i + "px"), e.show() }), t(window).trigger("resize") }); var artButtonSetup = function (t) { "use strict"; return function (e) { t.each(t("a." + e + ", button." + e + ", input." + e), function (e, r) { var i = t(r); i.hasClass("art-button") || i.addClass("art-button"), i.is("input") && i.val(i.val().replace(/^\s*/, "")).css("zoom", "1"), i.mousedown(function () { t(this).addClass("active") }), i.mouseup(function () { var e = t(this); e.hasClass("active") && e.removeClass("active") }), i.mouseleave(function () { var e = t(this); e.hasClass("active") && e.removeClass("active") }) }) } }(jQuery); jQuery(function () { "use strict"; artButtonSetup("art-button") }), jQuery(function (t) { "use strict"; t('input.art-search-button, form.art-search input[type="submit"]').attr("value", "") }); var Control = function (t) { "use strict"; return function () { this.init = function (e, r, i) { "checked" === e.find('input[type="' + r + '"]').attr("checked") && e.addClass("art-checked"), e.mouseleave(function () { t(this).removeClass("hovered").removeClass("active") }), e.mouseover(function () { t(this).addClass("hovered").removeClass("active") }), e.mousedown(function (e) { 1 === e.which && t(this).addClass("active").removeClass("hovered") }), e.mouseup(function (e) { 1 === e.which && (i.apply(this), t(this).removeClass("active").addClass("hovered")) }) } } }(jQuery); jQuery(function (t) { "use strict"; t(".art-pager").contents().filter(function () { return this.nodeType === this.TEXT_NODE }).remove() }); var fixRssIconLineHeight = function (t) { "use strict"; return function (e) { t("." + e).css("line-height", t("." + e).height() + "px") } }(jQuery); jQuery(function (t) { "use strict"; var e = t(".art-rss-tag-icon"); e.length && (fixRssIconLineHeight("art-rss-tag-icon"), t.browser.msie && parseInt(t.browser.version, 10) < 9 && e.each(function () { "" === t.trim(t(this).html()) && t(this).css("vertical-align", "middle") })) }), function (t) { "use strict"; t.fn.mousewheel = function (t) { return this[t ? "bind" : "trigger"]("wheel", t) }, t.event.special.wheel = { setup: function () { t.event.add(this, e, r, {}) }, teardown: function () { t.event.remove(this, e, r) } }; var e = t.browser.mozilla ? "DOMMouseScroll" + (t.browser.version < "1.9" ? " mousemove" : "") : "mousewheel"; function r(e) { switch (e.type) { case "mousemove": return t.extend(e.data, { clientX: e.clientX, clientY: e.clientY, pageX: e.pageX, pageY: e.pageY }); case "DOMMouseScroll": t.extend(e, e.data), e.delta = -e.detail / 3; break; case "mousewheel": e.delta = e.wheelDelta / 120 }return e.type = "wheel", t.event.handle.call(this, e, e.delta) } }(jQuery); var ThemeLightbox = function (t) { "use strict"; return function () { var e, r = t(".art-lightbox"); function i(i) { if (!(i < 0 || i >= r.length)) { !1 ? t(".art-lightbox-wrapper").append(t('<div class="lightbox-error">The requested content cannot be loaded.<br/>Please try again later.</div>').css({ top: t(window).height() / 2 - 60, left: t(window).width() / 2 - 170 })) : t(".art-lightbox-wrapper .lightbox-error").remove(), e = i, t(".art-lightbox-wrapper .art-lightbox-image:not(.active)").remove(); var a = t(".art-lightbox-wrapper .active"), c = t('<img class="art-lightbox-image" alt="" src="' + l(t(r[e]).attr("src")) + '" />'); a.after(c), s(), n(!0), o(t(".art-lightbox-wrapper").add(c)), c.load(function () { n(!1), a.removeClass("active"), c.addClass("active") }), c.error(function () { n(!1), a.removeClass("active"), c.addClass("active"), c.attr("src", t(r[e]).attr("src")) }) } } function s() { 0 === t(".art-lightbox-wrapper .arrow").length && (t(".art-lightbox-wrapper").append(t('<div class="arrow left"><div class="arrow-t ccw"> </div><div class="arrow-b cw"> </div><div class="arrow-left-alt">&#8592;</div></div>').css("top", t(window).height() / 2 - 40)), t(".art-lightbox-wrapper").append(t('<div class="arrow right"><div class="arrow-t cw"> </div><div class="arrow-b ccw"> </div><div class="arrow-right-alt">&#8594;</div></div>').css("top", t(window).height() / 2 - 40))), 0 === e ? t(".art-lightbox-wrapper .arrow.left").addClass("disabled") : t(".art-lightbox-wrapper .arrow.left").removeClass("disabled"), e === r.length - 1 ? t(".art-lightbox-wrapper .arrow.right").addClass("disabled") : t(".art-lightbox-wrapper .arrow.right").removeClass("disabled") } function n(e) { e ? t('<div class="loading"> </div>').css({ top: t(window).height() / 2 - 16, left: t(window).width() / 2 - 16 }).appendTo(t(".art-lightbox-wrapper")) : t(".art-lightbox-wrapper .loading").remove() } this.init = function (c) { t(".art-lightbox").live("click", { _ctrl: c }, function (i) { (!0 !== i.data._ctrl || i.ctrlKey) && (r = t(".art-lightbox"), e = r.index(this), function (e) { var r = t('<div class="close"><div class="cw"> </div><div class="ccw"> </div><div class="close-alt">&#10007;</div></div>').click(a), i = t(".art-lightbox-wrapper"); 0 === i.length && (i = t('<div class="art-lightbox-wrapper">').css("line-height", t(window).height() + "px").appendTo(t("body"))); var c = t('<img class="art-lightbox-image active" src="' + l(t(e).attr("src")) + '">'); c.appendTo(i), s(), r.appendTo(i), n(!0), c.load(function () { n(!1) }), c.error(function () { n(!1), c.attr("src", t(e).attr("src")) }), o(t(".art-lightbox-wrapper .arrow").add(c).add(i)) }(this)) }), t(".art-lightbox-wrapper .arrow.left:not(.disabled)").live("click", function () { i(e - 1) }), t(".art-lightbox-wrapper .arrow.right:not(.disabled)").live("click", function () { i(e + 1) }), t(".art-lightbox-wrapper .active").live("click", function () { i(e + 1) }), t(".art-lightbox-wrapper .close").live("click", function () { a() }) }; var a = function () { t(".art-lightbox-wrapper").remove() }; function o(t) { t.unbind("wheel").mousewheel(function (t, r) { i(e + (r = r > 0 ? 1 : -1)), t.preventDefault() }), t.mousedown(function (t) { 2 === t.which && a(), t.preventDefault() }) } function l(t) { var e = t.substring(0, t.lastIndexOf(".")), r = t.substring(t.lastIndexOf(".")); return t = e + "-large" + r } } }(jQuery); jQuery(function () { "use strict"; (new ThemeLightbox).init() }), function (t) { "use strict"; var e, r; t.support.transition = (void 0 !== (r = (document.body || document.documentElement).style).transition || void 0 !== r.WebkitTransition || void 0 !== r.MozTransition || void 0 !== r.MsTransition || void 0 !== r.OTransition) && { event: function () { var e = "transitionend"; if (t.browser.opera) { var r = parseFloat(t.browser.version); e = r >= 12 ? r < 12.5 ? "otransitionend" : "transitionend" : "oTransitionEnd" } else t.browser.webkit && (e = "webkitTransitionEnd"); return e }(), prefix: (t.each(t.browser, function (t, r) { return "version" === t || !(e = { opera: "-o-", mozilla: "-moz-", webkit: "-webkit-", msie: "-ms-" }[t]) }), e || "") }, window.BackgroundHelper = function () { var e = [], r = "next", i = "horizontal", s = 0, n = 0, a = 1, o = ""; function l(t, e) { var r = []; if (void 0 === t) return ""; e.x = e.x || 0, e.y = e.y || 0; for (var i = 0; i < t.length; i++)r.push(t[i].x * a + e.x + "px " + (t[i].y * a + e.y) + "px"); return r.join(", ") } this.init = function (t, l, c) { r = l, i = t, e = [], s = 0, n = 0, a = 1, o = c }, this.processSlide = function (r, i) { this.updateSize(r, null); var s = [], n = r.css("background-position").split(","); t.each(n, function (e) { var r = t.trim(this).split(" "); if (r.length > 1) { var i = parseInt(r[0], 10), n = parseInt(r[1], 10); s.push({ x: i, y: n }) } }), e.push({ images: r.css("background-image"), sizes: r.css("background-size"), positions: s }), i && r.css("background-image", "none") }, this.updateSize = function (r, o) { s = r.outerWidth(!1), n = r.outerHeight(), o && 0 !== parseInt(o.width, 10) && (a = s / o.width, "fade" === i && t.each(r.children(), function (r) { t(this).css("background-position", l(e[r].positions, { x: 0, y: 0 })) })) }, this.setBackground = function (e, r) { var i = [], s = []; t.each(r, function (t, e) { i.push(e.images), s.push(e.sizes) }), e.css({ "background-image": i.join(", "), "background-size": s.join(", "), "background-repeat": "no-repeat" }) }, this.setPosition = function (e, r) { var i = []; t.each(r, function (t, e) { i.push(e.positions) }), e.css({ "background-position": i.join(", ") }) }, this.current = function (t) { return e[t] || null }, this.next = function (t) { var i; return "next" === r ? i = (t + 1) % e.length : (i = t - 1) < 0 && (i = e.length - 1), e[i] }, this.items = function (t, e, a) { var o = { x: 0, y: 0 }, c = { x: 0, y: 0 }, u = "next" === r; "horizontal" === i ? (c.x = u ? s : -s, c.y = 0, a && (o.x += u ? -s : s, c.x += u ? -s : s)) : "vertical" === i && (c.x = 0, c.y = u ? n : -n, a && (o.y += u ? -n : n, c.y += u ? -n : n)); var d = []; return t && d.push({ images: t.images, positions: l(t.positions, o), sizes: t.sizes }), e && d.push({ images: e.images, positions: l(e.positions, c), sizes: e.sizes }), "next" === r && d.reverse(), d }, this.transition = function (e, r) { e.css(t.support.transition.prefix + "transition", r ? o + " ease-in-out background-position" : "") } }; var i = function (e, r) { var i = null, s = !1, n = e.find(".active").parent().children(), a = !1, o = !1; if (this.settings = t.extend({}, { animation: "horizontal", direction: "next", speed: 600, pause: 2500, auto: !0, repeat: !0, navigator: null, clickevents: !0, hover: !0, helper: null }, r), this.move = function (r, o) { var l = e.find(".active"), c = o || l[r](), u = "next" === this.settings.direction ? "forward" : "back", d = "next" === r ? "first" : "last", h = i, f = this; if (s = !0, h && this.stop(!0), !c.length && (c = e.find(".art-slide-item")[d](), !this.settings.repeat)) return a = !0, void (s = !1); t.support.transition ? (c.addClass(this.settings.direction), c.get(0).offsetHeight, l.addClass(u), c.addClass(u), e.trigger("beforeSlide", n.length), e.one(t.support.transition.event, function () { c.removeClass(f.settings.direction).removeClass(u).addClass("active"), l.removeClass("active").removeClass(u), s = !1, setTimeout(function () { e.trigger("afterSlide", n.length) }, 0) })) : (e.trigger("beforeSlide", n.length), l.removeClass("active"), c.addClass("active"), s = !1, e.trigger("afterSlide", n.length)), this.navigate(c), h && this.start() }, this.navigate = function (e) { var r = n.index(e); t(this.settings.navigator).children().removeClass("active").eq(r).addClass("active") }, this.to = function (r) { var i = e.find(".active"), n = i.parent().children(), a = n.index(i), o = this; if (!(r > n.length - 1 || r < 0)) return s ? e.one("afterSlide", function () { o.to(r) }) : void (a !== r && this.move(r > a ? "next" : "prev", t(n[r]))) }, this.next = function () { if (!s) { if (a) return void this.stop(); this.move("next") } }, this.prev = function () { if (!s) { if (a) return void this.stop(); this.move("prev") } }, this.start = function (e) { e && setTimeout(t.proxy(this.next, this), 10), i = setInterval(t.proxy(this.next, this), this.settings.pause), o = !0 }, this.stop = function (t) { clearInterval(i), i = null, o = !!t, s = !1 }, this.active = function () { return o }, this.moving = function () { return s }, this.navigate(n.filter(".active")), this.settings.clickevents && t(this.settings.navigator).on("click", "a", { slider: this }, function (e) { var r = n.index(n.filter(".active")), i = t(this).parent().children().index(t(this)); r !== i && e.data.slider.to(i), e.preventDefault() }), this.settings.hover) { var l = this; e.add(this.settings.navigator).add(e.siblings(".art-shapes")).hover(function () { e.is(":visible") && !a && l.stop(!0) }, function () { e.is(":visible") && !a && l.start() }) } }; t.fn.slider = function (e) { return this.each(function () { var r = t(this), s = r.data("slider"); s || (s = new i(r, "object" == typeof e && e), r.data("slider", s)), "string" == typeof e && s[e] ? s[e]() : s.settings.auto && r.is(":visible") && s.start() }) } }(jQuery), jQuery(function (t) { "use strict"; if (t.browser.msie && !(parseInt(t.browser.version, 10) > 8)) { var e = "", r = t("script[src*='script.js']"); if (r.length > 0) { var i = r.last().attr("src"); e = i.substr(0, i.indexOf("script.js")) } processHeaderMultipleBg(e) } }); var processHeaderMultipleBg = function (t) { "use strict"; return function (e) { for (var r = t(".art-header"), i = "".split(","), s = "".split(","), n = i.length - 1; n >= 0; n--) { var a = t.trim(i[n]); "" !== a && ("" !== e && (a = a.replace(/(url\(['"]?)/i, "$1" + e)), r.append('<div style="position:absolute;top:0;left:0;width:100%;height:100%;background:' + a + " " + s[n] + ' no-repeat">')) } r.css("background-image", "url('images/header.jpg')".replace(/(url\(['"]?)/i, "$1" + e)), r.css("background-position", "0 0") } }(jQuery); function fun_load() { $("img").addClass("art-lightbox") } function applySubmit() { if (0 == document.forms[0].firstname.value.length) return document.forms[0].firstname.focus(), alert("Please enter your name"), !1; if (0 == document.forms[0].city.value.length) return document.forms[0].city.focus(), alert("Please enter city"), !1; if (0 == document.forms[0].country.value) return document.forms[0].country.focus(), alert("Please choose your country"), !1; if (10 != document.forms[0].mobile.value.length) return document.forms[0].mobile.focus(), alert("Please enter your valid 10 digit mobile number"), !1; if (0 == document.forms[0].email.value.length) return document.forms[0].email.focus(), alert("Please enter your email id"), !1; var t = document.forms[0].email.value; return /^\w+([\.-]?\w+)*@\w+([\.-]?\w+)*(\.\w{2,3})+$/.test(t) ? 0 == document.forms[0].comment.value.length ? (document.forms[0].comment.focus(), alert("Please enter your comments/feedback"), !1) : void 0 : (document.forms[0].email.focus(), alert("Please enter a valid email id"), !1) }

  </script>
  <script>
    var responsiveDesign = { isResponsive: !1, isDesktop: !1, isTablet: !1, isPhone: !1, windowWidth: 0, responsive: function (e) { "use strict"; return function () { var s = e("html"); this.windowWidth = e(window).width(); var i = !1, t = e("#art-resp").is(":visible"); t && !this.isResponsive ? (s.addClass("responsive").removeClass("desktop"), this.isResponsive = !0, this.isDesktop = !1, i = !0) : t || this.isDesktop || (s.addClass("desktop").removeClass("responsive responsive-tablet responsive-phone"), this.isResponsive = this.isTablet = this.isPhone = !1, this.isDesktop = !0, i = !0), this.isResponsive && (e("#art-resp-t").is(":visible") && !this.isTablet ? (s.addClass("responsive-tablet").removeClass("responsive-phone"), this.isTablet = !0, this.isPhone = !1, i = !0) : e("#art-resp-m").is(":visible") && !this.isPhone && (s.addClass("responsive-phone").removeClass("responsive-tablet"), this.isTablet = !1, this.isPhone = !0, i = !0)), i && e(window).trigger("responsive", this), e(window).trigger("responsiveResize", this) } }(jQuery), initialize: function (e) { "use strict"; return function () { var s; e('<div id="art-resp"><div id="art-resp-m"></div><div id="art-resp-t"></div></div>').appendTo("body"), e(window).resize(function () { clearTimeout(s), s = setTimeout(function () { responsiveDesign.responsive() }, 25) }), e(window).trigger("resize") } }(jQuery) }; function responsiveAbsBg(e, s, i) { "use strict"; if (0 !== i.length) { var t = i.attr("data-bg-top"), r = i.attr("data-bg-height"); if (e.isResponsive) { void 0 !== t && !1 !== t || (i.attr("data-bg-top", i.css("top")), i.attr("data-bg-height", i.css("height"))); var n = s.offset().top, o = s.outerHeight(); i.css("top", n + "px"), i.css("height", o + "px") } else void 0 !== t && !1 !== t && (i.css("top", t), i.css("height", r), i.removeAttr("data-bg-top"), i.removeAttr("data-bg-height")) } } var responsiveImages = function (e) { "use strict"; return function (s) { e("img[width]").each(function () { var i = e(this), t = "", r = "", n = ""; if (s.isResponsive) { t = "auto", n = "auto", r = "100%"; var o = i.attr("width"); null !== o && "string" == typeof o && -1 === o.indexOf("%") && (t = "100%", r = parseInt(e.trim(o), 10) + "px") } i.css("width", t).css("max-width", r).css("height", n) }) } }(jQuery), responsiveVideos = function (e) { "use strict"; return function (s) { e("iframe,object,embed").each(function () { var i = e(this), t = i.parent(".art-responsive-embed"); if (s.isResponsive) { if (0 !== t.length) return; t = e('<div class="art-responsive-embed">').insertBefore(i), i.appendTo(t) } else t.length > 0 && (i.insertBefore(t), t.remove()) }) } }(jQuery), responsiveTextblocks = function (e) { "use strict"; return function (s, i) { s.find(".art-textblock").each(function () { if (0 === parseInt(s.attr("data-width"), 10)) return !0; var t = e(this), r = s.width() / s.attr("data-width"); if (t.css({ height: "", width: "", top: "", "margin-left": "" }), i.isResponsive) { var n = parseInt(t.css("height"), 10), o = parseInt(t.css("width"), 10), a = parseInt(t.css("top"), 10), d = parseInt(t.css("margin-left"), 10); t.add(t.children()).css({ height: n * r, width: o * r }), t.css("top", a * r), t.attr("style", function (e, s) { return s + "margin-left: " + d * r + "px !important" }) } }) } }(jQuery), responsiveSlider = function (e) { "use strict"; return function (s) { e(".art-slider").each(function () { var i = e(this); if (responsiveTextblocks(i, s), s.isResponsive) { var t = i.attr("data-width"), r = i.attr("data-height"), n = i.width() / t * r; i.css("height", n + "px"); var o = i.data("slider"); if (o && o.settings.helper) { var a = i.find(".art-slider-inner"); o.settings.helper.updateSize(a, { width: t, height: r }) } } else i.removeAttr("style") }) } }(jQuery), responsiveCollages = function (e) { "use strict"; return function (s) { e(".art-collage").each(function () { var i = e(this), t = i.closest(":not(.image-caption-wrapper, .art-collage)").width(), r = i.width(), n = i.children(".art-slider").attr("data-width"); s.isResponsive && r > t ? i.add(i.find(".art-slider")).add(i.closest(".image-caption-wrapper")).css("width", "100%") : (!s.isResponsive || r > n) && i.add(i.find(".art-slider")).add(i.closest(".image-caption-wrapper")).css("width", "") }) } }(jQuery), responsiveNavigator = function (e) { "use strict"; return function (s) { e(".art-slider").each(function () { var i = e(this), t = i.width(), r = i.siblings(".art-slidenavigator"); if (r.length) if (s.isResponsive) { var n = r.attr("data-left"), o = t - t * parseFloat(n) / 100 - r.outerWidth(!1); o < 0 && r.css("margin-left", o); var a = i.css("height"); r.css("top", ""); var d = parseInt(r.attr("data-offset") || 0, 10); r.css("top", parseInt(r.css("top"), 10) - (i.attr("data-height") - parseInt(a, 10)) + d) } else r.removeAttr("data-offset"), r.removeAttr("style") }) } }(jQuery); function responsiveSlideshow(e) { "use strict"; responsiveCollages(e), responsiveSlider(e), responsiveNavigator(e) } jQuery(window).bind("responsive", function (e) { "use strict"; return function (s, i) { responsiveImages(i), responsiveVideos(i), e.browser.msie && e.browser.version <= 8 || (i.isResponsive ? e(window).on("responsiveResize.slider", function () { responsiveSlideshow(i) }) : (e(window).trigger("responsiveResize.slider"), e(window).off("responsiveResize.slider"))) } }(jQuery)); var responsiveHeader = function (e) { "use strict"; return function (s) { var i = e("header.art-header"), t = i.find(".art-slider"); if (t.length) { var r = t.find(".art-slide-item").first().css("background-image").split(","), n = t.prev(), o = t.siblings(".art-slidenavigator"); r.length && s.isResponsive ? (i.css("background-image", r[r.length - 1]), i.css("min-height", "0"), n.is("nav.art-nav") && o.attr("data-offset", n.height())) : (o.removeAttr("data-offset"), i.removeAttr("style")) } } }(jQuery); jQuery(window).bind("responsiveResize", function (e) { "use strict"; return function (s, i) { responsiveAbsBg(i, e(".art-header"), e("#art-header-bg")) } }(jQuery)), jQuery(window).bind("responsive", function (e) { "use strict"; return function (s, i) { e.browser.msie && e.browser.version <= 8 || (i.isResponsive ? e(window).on("responsiveResize.header", function () { responsiveHeader(i) }) : (e(window).trigger("responsiveResize.header"), e(window).trigger("resize"), e(window).off("responsiveResize.header"))) } }(jQuery)), jQuery(window).bind("responsiveResize", function (e) { "use strict"; return function (s, i) { responsiveAbsBg(i, e("nav.art-nav"), e("#art-hmenu-bg")) } }(jQuery)), jQuery(function (e) { e('<a href="#" class="art-menu-btn"><span></span><span></span><span></span></a>').insertBefore(".art-hmenu").click(function (s) { var i = e(this).next(); i.is(":visible") ? i.slideUp("fast", function () { e(this).removeClass("visible").css("display", "") }) : i.slideDown("fast", function () { e(this).addClass("visible").css("display", "") }), s.preventDefault() }) }), jQuery(window).bind("responsiveNav", function (e) { "use strict"; return function (s, i) { i.isDesktopNav && e("li.ext").length > 0 && menuExtendedCreate() } }(jQuery)); var responsiveLayoutCell = function (e) { "use strict"; return function (s) { e(".art-content .art-content-layout-row,.art-footer .art-content-layout-row").each(function () { var i = e(this), t = i.children(".art-layout-cell"); t.length > 1 && (s.isTablet ? t.addClass("responsive-tablet-layout-cell").each(function (s) { (s + 1) % 2 == 0 && e(this).after('<div class="cleared responsive-cleared">') }) : (t.removeClass("responsive-tablet-layout-cell"), i.children(".responsive-cleared").remove())) }) } }(jQuery); jQuery(window).bind("responsive", function (e, s) { "use strict"; responsiveLayoutCell(s) }), (!jQuery.browser.msie || jQuery.browser.version > 8) && jQuery(responsiveDesign.initialize);

  </script>
  <script>
    !function (e) { "use strict"; var t = {}; e.respond = t, t.update = function () { }; var a = [], n = function () { var t = !1; try { t = new e.XMLHttpRequest } catch (a) { t = new e.ActiveXObject("Microsoft.XMLHTTP") } return function () { return t } }(), r = function (e, t) { var a = n(); a && (a.open("GET.html", e, !0), a.onreadystatechange = function () { 4 !== a.readyState || 200 !== a.status && 304 !== a.status || t(a.responseText) }, 4 !== a.readyState && a.send(null)) }, s = function (e) { return e.replace(t.regex.minmaxwh, "").match(t.regex.other) }; if (t.ajax = r, t.queue = a, t.unsupportedmq = s, t.regex = { media: /@media[^\{]+\{([^\{\}]*\{[^\}\{]*\})+/gi, keyframes: /@(?:\-(?:o|moz|webkit)\-)?keyframes[^\{]+\{(?:[^\{\}]*\{[^\}\{]*\})+[^\}]*\}/gi, comments: /\/\*[^*]*\*+([^/][^*]*\*+)*\//gi, urls: /(url\()['"]?([^\/\)'"][^:\)'"]+)['"]?(\))/g, findStyles: /@media *([^\{]+)\{([\S\s]+?)$/, only: /(only\s+)?([a-zA-Z]+)\s?/, minw: /\(\s*min\-width\s*:\s*(\s*[0-9\.]+)(px|em)\s*\)/, maxw: /\(\s*max\-width\s*:\s*(\s*[0-9\.]+)(px|em)\s*\)/, minmaxwh: /\(\s*m(in|ax)\-(height|width)\s*:\s*(\s*[0-9\.]+)(px|em)\s*\)/gi, other: /\([^\)]*\)/g }, t.mediaQueriesSupported = e.matchMedia && null !== e.matchMedia("only all") && e.matchMedia("only all").matches, !t.mediaQueriesSupported) { var i, o, l, m = e.document, h = m.documentElement, d = [], u = [], c = [], p = {}, f = m.getElementsByTagName("head")[0] || h, g = m.getElementsByTagName("base")[0], x = f.getElementsByTagName("link"), y = function () { var e, t = m.createElement("div"), a = m.body, n = h.style.fontSize, r = a && a.style.fontSize, s = !1; return t.style.cssText = "position:absolute;font-size:1em;width:1em", a || ((a = s = m.createElement("body")).style.background = "none"), h.style.fontSize = "100%", a.style.fontSize = "100%", a.appendChild(t), s && h.insertBefore(a, h.firstChild), e = t.offsetWidth, s ? h.removeChild(a) : a.removeChild(t), h.style.fontSize = n, r && (a.style.fontSize = r), e = l = parseFloat(e) }, v = function (t) { var a = h.clientWidth, n = "CSS1Compat" === m.compatMode && a || m.body.clientWidth || a, r = {}, s = x[x.length - 1], p = (new Date).getTime(); if (t && i && p - i < 30) return e.clearTimeout(o), void (o = e.setTimeout(v, 30)); for (var g in i = p, d) if (d.hasOwnProperty(g)) { var w = d[g], E = w.minw, S = w.maxw, T = null === E, $ = null === S; E && (E = parseFloat(E) * (E.indexOf("em") > -1 ? l || y() : 1)), S && (S = parseFloat(S) * (S.indexOf("em") > -1 ? l || y() : 1)), w.hasquery && (T && $ || !(T || n >= E) || !($ || n <= S)) || (r[w.media] || (r[w.media] = []), r[w.media].push(u[w.rules])) } for (var z in c) c.hasOwnProperty(z) && c[z] && c[z].parentNode === f && f.removeChild(c[z]); for (var b in c.length = 0, r) if (r.hasOwnProperty(b)) { var C = m.createElement("style"), R = r[b].join("\n"); C.type = "text/css", C.media = b, f.insertBefore(C, s.nextSibling), C.styleSheet ? C.styleSheet.cssText = R : C.appendChild(m.createTextNode(R)), c.push(C) } }, w = function (e, a, n) { var r = e.replace(t.regex.comments, "").replace(t.regex.keyframes, "").match(t.regex.media), i = r && r.length || 0, o = function (e) { return e.replace(t.regex.urls, "$1" + a + "$2$3") }, l = !i && n; (a = a.substring(0, a.lastIndexOf("/"))).length && (a += "/"), l && (i = 1); for (var m = 0; m < i; m++) { var h, c, p, f; l ? (h = n, u.push(o(e))) : (h = r[m].match(t.regex.findStyles) && RegExp.$1, u.push(RegExp.$2 && o(RegExp.$2))), f = (p = h.split(",")).length; for (var g = 0; g < f; g++)c = p[g], s(c) || d.push({ media: c.split("(")[0].match(t.regex.only) && RegExp.$2 || "all", rules: u.length - 1, hasquery: c.indexOf("(") > -1, minw: c.match(t.regex.minw) && parseFloat(RegExp.$1) + (RegExp.$2 || ""), maxw: c.match(t.regex.maxw) && parseFloat(RegExp.$1) + (RegExp.$2 || "") }) } v() }, E = function () { if (a.length) { var t = a.shift(); r(t.href, function (a) { w(a, t.href, t.media), p[t.href] = !0, e.setTimeout(function () { E() }, 0) }) } }, S = function () { for (var t = 0; t < x.length; t++) { var n = x[t], r = n.href, s = n.media, i = n.rel && "stylesheet" === n.rel.toLowerCase(); r && i && !p[r] && (n.styleSheet && n.styleSheet.rawCssText ? (w(n.styleSheet.rawCssText, r, s), p[r] = !0) : (/^([a-zA-Z:]*\/\/)/.test(r) || g) && r.replace(RegExp.$1, "").split("/")[0] !== e.location.host || ("//" === r.substring(0, 2) && (r = e.location.protocol + r), a.push({ href: r, media: s }))) } E() }; S(), t.update = S, t.getEmValue = y, e.addEventListener ? e.addEventListener("resize", T, !1) : e.attachEvent && e.attachEvent("onresize", T) } function T() { v(!0) } }(this);
  </script>
  <script>
    // JavaScript Document
...
<body>
  ...
  <!--<div id="kala"><button type="button" value="X" class="close_button">X</button><img src="UPLOAD.jpg" width="100%"></div>-->
  <a href="#" class="logo"></a>
  <header>
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12 bgtp">Call:<a style="color:white;" href="tel:8050412609">8050412609</a>,&nbsp;<a
            style="color:white;" href="tel:8867067333">8867067333</a></div>
      </div>
    </div>
    <!-- Static navbar -->
    <div class="navbar navbar-default scrollMenu ">
      ...
      <div class="navbar-collapse collapse navbar-right">
        <ul style="z-index:1000;" class="nav navbar-nav  ">
          <li style="z-index:1000;"><a href="index-2.html">Home</a></li>
          <li class="dropdown"><a href="javascript:void()" class="dropdown-toggle" data-toggle="dropdown">About Us<b
                class="caret"></b></a>
            <ul style="z-index:1000;" class="dropdown-menu">
              <li><a href="about-us.html">About Us</a></li>
              <li><a href="animation-industry.html">Animation Industry</a></li>
            </ul>
          </li>
          <li class="dropdown">
            <a href="javascript:void()" class="dropdown-toggle" data-toggle="dropdown">Courses <b class="caret"></b></a>
            <ul style="z-index:1000;" class="dropdown-menu">
              <li><a href="graphic-design.html">Graphics and Web</a></li>
              <li><a href="ui-ux-design.html">UI/UX</a></li>
              <li><a href="trinity-course.html">Trinity 3D </a></li>
              <li><a href="animation-diploma-course.html">Diploma in Animation Engineering (DAE) </a></li>
              <li><a href="vfx-animation-course.html">Degree in Visual Fx and Animation </a></li>
              <li><a href="vfx-prime.html">VISUAL CONTENT DEVELOPMENT FOR PRINT AND SOCIAL MEDIA</a></li>
              <li><a href="vfx-pro.html">VFx Pro</a></li>
              <li><a href="game-art-design.html">Gaming</a></li>
              <li><a href="Short-term-courses.html">Short Term Professional Courses</a></li>
            </ul>
          </li>
          <li class="dropdown">
            <a href="javascript:avoid()" class="dropdown-toggle" data-toggle="dropdown">Activities <b
                class="caret"></b></a>
            <ul style="z-index:1000;" class="dropdown-menu">
          ...
          <li class="dropdown">
            <a href="placement.html" class="dropdown-toggle" data-toggle="dropdown">Placements <b class="caret"></b></a>
            <ul style="z-index:1000;" class="dropdown-menu">
          ...
          <li><a href="dataform.html">Online Fee Payment</a></li>
  ...
  <div id="banner">
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        ...
        <div class="item ">
          <a href="graphic-design.html" target="blank">
            <img src="images/hope.jpg" alt="Graphic Design Course Arena Banashakari" style="width:100%" loading="lazy">
          </a>
        </div>

        <div class="item">
          <a href="animation-diploma-course.html" target="blank"><img
              src="images/2d-animation-course-arena-jayanagar-1440x500.jpg" alt="2D Animation Course Arena Banashankari"
              style="width:100%" loading="lazy"></a>
        </div>

        <div class="item active">
          <a href="trinity-course.html" target="blank"><img src="images/trinity-3d-course-arena-jayanagar-1440x500.jpg"
              alt="Trinity 3D Course Arena Banashankari" style="width:100%" loading="lazy"></a>
        </div>

        <div class="item">
          <a href="vfx-animation-course.html" target="blank"><img
              src="images/degree-in-animation-and-gaming-course-arena-jayanagar-1440x496.jpg"
              alt="Degree VFX and Animation Course" style="width:100%" loading="lazy"></a>
        </div>
        <div class="item">
          <a href="animation-diploma-course.html" target="blank"><img
              src="images/3d-character-animation-course-arena-jayanagar-1440x500.jpg"
              alt="Animation course in Bangalore" style="width:100%" loading="lazy"></a>
        </div>
        <div class="item">
          <a href="game-art-design.html" target="blank"><img
              src="images/game-design-course-arena-jayanagar-1440-500.jpg" alt="Game Design Course Arena Banashankari"
              style="width:100%" loading="lazy"></a>
        </div>
        <div class="item">
          <a href="ui-ux-design.html" target="blank"><img src="images/ui-and-ux-course-arena-jayanagar-1440x500.jpg"
  ...
  <div id="iconswrap">
    <div class="banwrp">
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12 flashnewswrp clearfix">
          <div class="ticker well" data-duration="60" data-loop="2" data-effect="linear" style="overflow: hidden;">
            <span style="white-space: nowrap; position: relative; transition: left 60s linear 0s; left: -2395px;">Arena
              Alumni Mr.Srinivas T gets a credit as a compositor in the Hollywood movie Antman Wasp
              QUANTUMANIA&nbsp;&nbsp;<img src="images/new_bullet.jpg" width="41" height="20" alt="Bullet point"
                loading="lazy">&nbsp;&nbsp;Arena Banashankari successfully places the latest batch of VFx students at
              DNEG"&nbsp;&nbsp;<img src="images/new_bullet.jpg" width="41" height="20"
                alt="Bullet point">&nbsp;&nbsp;“OCEAN”, the Stop Motion Animation movie done by the students of Arena
              Banashankari bags 4 awards along with the best movie award @ THE ASIFA INDIA AWARDS OF EXCELLENCE
              2022-23&nbsp;&nbsp;<img src="images/new_bullet.jpg" width="41" height="20" alt="Bullet point"
                loading="lazy">&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/new_bullet.jpg" width="41" height="20"
                alt="Bullet point" loading="lazy">&nbsp;&nbsp; Arena Banashankari takes the lead to celebrate
              International Animation Day (IAD 2022) @ Yuvaka Sangha, Banashankari 4th Block&nbsp;&nbsp;<img
            ...
            <div class="col-md-4 col-md-push-8 col-sm-4 col-sm-push-8">
              <div class="row wow fadeInRight">
                <div class="clickwrp col-md-6 col-sm-6 col-xs-6">
                  ...
                  <a href="contactus.html"><img src="images/click2call.jpg" width="60" height="60" alt="Click to Call"
                      border="0" / loading="lazy"><br>
                    Contact Us </a>
                </div>
                <div class="downloadwrp col-md-6 col-sm-6 col-xs-6">
                  <a href="download.html"><img src="images/download_icon.png" width="60" height="60" alt="Icon"
                      border="0" loading="lazy"><br>
              ...
              <div class="row wow fadeInLeft">
                <div class="studwrks col-md-6 col-sm-6 col-xs-6">
                  <a href="students-works.html">
                    <img src="images/stud_works.jpg" width="60" height="60" alt="Student works" border="0"><br>
                    STUDENTS Works</a>
                </div>
                <div class="studspeak col-md-6 col-sm-6 col-xs-6"><a href="students_speak.html"><img
                      src="images/stud_speak.jpg" width="60" height="60" alt="Student speak" border="0"
                      loading="lazy"><br>
                    STUDENTS SPEAKS</a>
                </div>
              </div>
            </div>
            <div class="abtwrp col-md-8 col-md-pull-4 col-sm-8 col-sm-pull-4 wow fadeInLeft"><br>
              <h1>The Best Animation Institute in Bangalore</h1>

              <p class="hedcontts">Arena Creative Campus Banashankari was established in the year 1996 and is India’s
                best animation, VFX, Gaming, Graphics, and Web Design College. Arena Banashankari Bangalore is the top
              ...
              <p class="hedcontts">The main objective of Arena is to empower youth with knowledge, skills, and values so
                ...
                &nbsp;<span class="mre"><a href="about-us.html">Read More..</a></span></p>
            </div>
          </div>
        </div>
      </div> <!-- Banner Row--->
      <section class="pgdm__section bg-ht position-relative py-5" data-scroll-index='2'>
        <div class="container">
          <div class="row">
            <div class="col-lg-6 col-md-12 pgdmThumb pt-4 wow fadeInUp" data-wow-delay="300ms">
              <div class="pgdm_absolute">
                <div class="thumb-fluid position-relative pl-3"> <img class="img-fluid shadow border-white"
                    src="images/pgdm-thumb1.jpg" alt="Animation course" /> </div>
              </div>
            </div>
            <div class="col-lg-6 col-md-12 wow fadeInUp" data-wow-delay="600ms">
              <div class="widget-title mb-3 mt-5">
                <h3 class="helleded">Placement Cell @ Arena Animation Banashankari</h3>
              </div>
              <p class="text-black">Arena Animation, Banashankari is proud to have a track record of 100% placements
                over the last 25 years. Each and every student who has joined the institute has stepped out with a job.
                Placement assistance is provided to all the students during their course duration. We team up with the
                top international and Indian companies for placement. Based on the performance of the students, they get
                Offer Letters from renowned companies even before they complete their program. Our faculty members make
                every effort to train the students and organize different seminars, workshops, and placement training
                sessions. Arena Animation Banashankari, the <b>best animation college in Bangalore</b> firmly believes
                that to be imperative, the students need to prepare for the transition from academics to the rigors of
                the professional world with industry-oriented training. </p>
              <p class="mt-3 text-black">Arena Animation Banashankari works closely with industry experts and renowned
                animation companies to offer the students with the best industry exposure. </p>
            </div>
          </div>
        </div>
      </section>
      <section class="pgmarkeing__section bg-ht position-relative py-5" data-scroll-index="3">
        <div class="container">
          <div class="row">
            <div class="col-lg-6 col-md-12 pgdmThumbs pt-4 order-md-2 wow fadeInUp" data-wow-delay="300ms"
              style="visibility: visible; animation-delay: 300ms; animation-name: fadeInUp;">
              <div class="pgdm_absolutes pgdm_green right">
                <div class="thumb-fluids position-relative pr-3"> <img class="img-fluid shadow border-white"
                    src="images/pgdm-thumb2.jpg" alt="3d Animation course"> </div>
              </div>
            </div>
            <div class="col-lg-6 col-md-12 pt-4 order-md-1 wow fadeInUp" data-wow-delay="600ms"
              style="visibility: visible; animation-delay: 600ms; animation-name: fadeInUp;">
              <div class="widget-title mb-3 mt-5">
                <h3 class="helled">Our Lecturers</h3>
              </div>
              <p class="text-white">Trainers with extensive experience in their respective fields will train you in 2D,
                3D, VFX, Gaming, Animation,<b> <a href="graphic-design.html" class="sni"> Graphic and Web Designing
                    Course</a> in Bangalore.</b> </p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div class="col-md-12 col-sm-12 col-xs-12 cleds">
            ...
            <div class="aris">
              <p>Arena Banashankari comprises two campuses spread across 20,000 sq. ft. It is equipped with spacious
                classrooms, computer labs and auditoriums added with the latest technology. There are other facilities
                too consisting of an open-air theatre, basketball court, and green screen room. There are 2 auditoriums
                to host different events, industry workshops, and seminars. </p>
              ...
              <p>The Curriculum of our <b>top animation institute in Bangalore</b> is updated as per the industry
                ...
                real-time project-oriented exercises to help them take on the animation world with vigor and passion.
                Our aim is to offer the students an education that emphasizes the fundaments so that they are the most
              ...
              <div id="myCarousel" class="carousel slide">
                <div class="carousel-inner">
                  <div class="item active">
                    <div class="row">
                      <div class="col-md-3 col-sm-3 col-xs-3"><a href="#" class="thumbnail"><img class="img-responsive"
                            src="images/2017.jpg" alt="Thumb11" style="width:100%" loading="lazy"></a>
                      </div>
                      <div class="col-md-3 col-sm-3 col-xs-3"><a href="lalbagh.html" class="thumbnail"><img
                            class="img-responsive" src="images/lalbhag.jpg" alt="Thumb11" style="width:100%"
                            loading="lazy"></a>
                      </div>
                      <div class="col-md-3 col-sm-3 col-xs-3"><a href="Mask%20Making%20competition.html"
                          class="thumbnail"><img class="img-responsive" src="images/maskmaking.jpg" alt="Thumb12"
                            style="width:100%" loading="lazy"></a>
                      </div>
                      <div class="col-md-3 col-sm-3 col-xs-3"><a href="T-Shirt%20Painting.html" class="thumbnail"><img
                            class="img-responsive" src="images/tshirtpaintng.jpg" alt="Thumb13" style="width:100%"
                            loading="lazy"></a>
                      </div>
                  ...
                  <div class="item">
                    <div class="row">
                      <div class="col-md-3 col-sm-3 col-xs-3"><a href="#" class="thumbnail"><img class="img-responsive"
                            src="images/clay%20modelling.jpg" alt="Thumb11" style="width:100%" loading="lazy"></a>
                      </div>
                      <div class="col-md-3 col-sm-3 col-xs-3"><a href="#" class="thumbnail"><img class="img-responsive"
                            src="images/hellowanday.jpg" alt="Thumb12" style="width:100%" loading="lazy"></a>
                      </div>
                      <div class="col-md-3 col-sm-3 col-xs-3"><a href="#" class="thumbnail"><img class="img-responsive"
                            src="images/Ganesh.jpg" alt="Thumb13" style="width:100%" loading="lazy"></a>
                      </div>
                      <div class="col-md-3 col-sm-3 col-xs-3"><a href="#" class="thumbnail"><img class="img-responsive"
                            src="images/durgapooja.jpg" alt="Thumb14" style="width:100%" loading="lazy"></a>
                      </div>
                    </div>
                  </div>
                  <div class="item">
                    <div class="row">
                      <div class="col-md-3 col-sm-3 col-xs-3"><a href="#" class="thumbnail"><img class="img-responsive"
                            src="images/arenaday.jpg" alt="Thumb11" style="width:100%" loading="lazy"></a>
                      </div>
                      <div class="col-md-3 col-sm-3 col-xs-3"><a href="#" class="thumbnail"><img class="img-responsive"
                            src="images/soapcarving.jpg" alt="Thumb12" style="width:100%" loading="lazy"></a>
                      </div>
                      <div class="col-md-3 col-sm-3 col-xs-3"><a href="#" class="thumbnail"><img class="img-responsive"
                            src="images/tasi.jpg" alt="Thumb13" style="width:100%" loading="lazy"></a>
                      </div>
                      <div class="col-md-3 col-sm-3 col-xs-3"><a href="#" class="thumbnail"><img class="img-responsive"
                            src="images/FilmFestival-14.jpg" alt="Thumb14" style="width:100%" loading="lazy"></a>
                      </div>
                    </div>
                  </div>
      ...
      <div class="container">
        <div class="row bgcartoon">
          <span class="wow fadeIn blox">COURSE DETAILS</span>
          <div class=" topspac col-md-4 col-sm-4 col-xs-12 wow fadeInLeft">
            <!--media-left Started here-->
            <div class="media">
              <div class="media-left">
                <a href="#"><img class="media-object" src="images/bullets.jpg" alt="Bullet point" border="0"
                    style="width:100%" loading="lazy"></a>
              </div><!--media-left ended here-->
              <!-- media-body started here -->
              <div class="media-body">
                <h4><a href="graphic-design.html">Graphic Design Courses</a></h4>
                <p>Graphic design, also known as communication design, is the art and practice <br>
                  of planning and projecting ideas and experiences&nbsp;<span class="medialink"><a
                      href="graphic-design.html">Read More</a></span></p>
              </div><!-- media-body started here -->
            </div><!--media ended here -->
            <!--media-left Started here-->
            <div class="media">
              <div class="media-left">
                <a href="#"><img class="media-object" src="images/bullets.jpg" alt="Bullet point" border="0"
              ...
              <!-- media-body started here -->
              <div class="media-body">
                <h4><a href="3d-animation-courses.html">3d Animation Courses</a></h4>
                <p>Arena Animation International Program (AAIP) --VFX is a comprehensive <br>
                  program that trains students end-to-end in all aspects of VFX.&nbsp; <span class="medialink"><a
                      href="3d-animation-courses.html">Read More</a></span></p>
              </div><!-- media-body started here -->
            </div><!--media ended here -->
            <!--media-left Started here-->
            <div class="media">
              ...
              <!-- media-body started here -->
              <div class="media-body">
                <h4><a href="animation-film-making.html">Virtual Reality - Augmented Reality Courses</a></h4>
                <p>In Animation Basics, learn how to realistically convey weight, motion and <br>
                  follow through critical skills on your journey&nbsp; <span class="medialink"><a
                      href="animation-film-making.html">Read More</a></span></p>
              </div><!-- media-body started here -->
            </div><!--media ended here -->
            <!--media-left Started here-->
            <div class="media">
              ...
              <!-- media-body started here -->
              <div class="media-body">
                <h4><a href="ui-ux-design.html">UI UX Designing Course</a></h4>
                <p>UI UX Course is the design of user interfaces for machines and software.
                  &nbsp; <span class="medialink"><a href="ui-ux-design.html">Read More</a></span></p>
              </div><!-- media-body started here -->
            </div><!--media ended here -->
          </div>
          ...
          <div class=" col-md-4 col-sm-4 col-xs-12 wow fadeInLeft">
            <!--media-left Started here-->
            <div class="mediaa"><img class="img-fluid" src="images/course-pic.png"
                alt="Animation and designing courses in bangalore" />
          ...
          <div class="topspac mediaalign col-md-4 col-sm-4 col-xs-12 wow fadeInRight">
            <!-- media-right start here -->
            <div class="media">
              <!-- media-body started here -->
              <div class="media-body">
                <h4><a href="web-design.html">Web Designing</a></h4>
                <p>Web design encompasses many different skills and disciplines in the <br>
                  production and maintenance of websites. &nbsp;<span class="medialink"><a href="web-design.html">Read
                      More</a></span></p>
              </div><!-- media-body started here -->
              <div class="media-right">
                <a href="#"><img class="media-object" src="images/bullets.jpg" alt="Bullet point" border="0"
                    style="width:100%" loading="lazy"></a>
              </div><!--media-right ended here -->
            </div><!-- media ended here -->
            <!-- media-right start here -->
            <div class="media">
              <!-- media-body started here -->
              <div class="media-body">
                <h4><a href="animation-courses.html">Animation Courses</a></h4>
                <p>Arena Animation International Program (Animation) helps you develop <br>
                  your skills &amp; build a professional work portfolio&nbsp; <span class="medialink"><a
                      href="animation-courses.html">Read More</a></span></p>
              </div><!-- media-body started here -->
              <div class="media-right">
                <a href="#"><img class="media-object" src="images/bullets.jpg" alt="Bullet point" border="0"
                    style="width:100%" loading="lazy"></a>
            ...
            <div class="media">
              <!-- media-body started here -->
              <div class="media-body">
                <h4><a href="game-art-design.html">Gaming Courses</a></h4>
                <p>Game design is the art of applying design and aesthetics to create a game <br>
                  to facilitate interaction between players for entertainment&nbsp; <span class="medialink"><a
                      href="game-art-design.html">Read More</a></span></p>
              </div><!-- media-body started here -->
              <div class="media-right">
                <a href="#"><img class="media-object" src="images/bullets.jpg" alt="Bullet point" border="0"
                    style="width:100%" loading="lazy"></a>
            ...
            <div class="media">
              <!-- media-body started here -->
              <div class="media-body">
                <h4><a href="vfx-animation-course.html">Degree in Animation and VFX Courses</a></h4>
                <p>VFX and Animation courses in Bangalore aim to provide <br> students with a better understanding of
                  animation.<br> <span class="medialink"><a href="vfx-animation-course.html">Read More</a></span></p>
              </div><!-- media-body started here -->
              <div class="media-right">
                <a href="#"><img class="media-object" src="images/bullets.jpg" alt="Bullet point" border="0"
                    style="width:100%" loading="lazy"></a>
    ...
    <div style="padding-top:0%;" class="studwrp studbg">
      <div class="studspekwrp">
        <div class="col-md-7 col-sm-7 col-xs-12 wow fadeInLeft">
          <div class="studwrkswrp">
            <h3>STUDENTS SPEAKS</h3>
            <p class="studbrd"></p>
            <div class="row">
              <div class="col-md-6 col-sm-6 col-xs-12"><video controls width="280px" height="200px">
                  <source src="images/Videos/Student-Testimonials1.mp4" />
              </div>

              <div class="col-md-6 col-sm-6 col-xs-12"><video controls width="280px" height="200px">
                  <source src="images/Videos/Student-Testimonials2.mp4" />
              </div>

              <div class="col-md-6 col-sm-6 col-xs-12"><video controls width="280px" height="200px">
                  <source src="images/Videos/Student-Testimonials3.mp4" />
              </div>

              <div class="col-md-6 col-sm-6 col-xs-12"><video controls width="280px" height="200px">
                  <source src="images/Videos/Student-Testimonials4.mp4" />
              </div>
            </div>
          ...
          </div><!--studwrkswrp ended here -->
        </div>
        <div class="col-md-5 col-sm-5 col-xs-12 wow fadeInRight">
          <div class="studspeakwrp">
            <h5>STUDENTS SPEAKS</h5>
            <p class="studspekbrd"></p>
            <div class="row">
              <div class=" studspekpad col-md-12 col-sm-12 ">
                <div class="carousel slide" data-ride="carousel" id="quote-carousel">
                  ...
                  <div class="carousel-inner">
                    ...
                    <div class="item active">
                      <div class="row">
                        <div class="col-md-12 col-sm-12">
                          <p>Through the Architectural designing course, Arena Animation Banashankari showed me the path
                            to fulfill my dreams. The faculty was good and helped me understand the basic concepts of
                            Architectural development.
                            <span class="viewmore"><br><a href="#">View more</a></span>
                          </p>
                          <span class="testioff"><strong class="testihed">Harshita D S </strong> – Working At Terrabytes
                            Visual Solutions, Architectural Visualiser - Sal:15,000p/m</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="item">
                      <div class="row">
                        <div class="col-sm-12">
                          <p>Got great support from Arena Banashankari and placements team. Such excellent placements
                            with a great pay of Rs 17K per month. Special Thanks to Arena Banashankari and Placements
                            team. <span class="viewmore"><br><a href="#">View more</a></span></p>
                          <span class="testioff"><strong class="testihed">Shridhar V</strong> – Working At Rockstar
                            Games (Technicolor), Gaming Artist - Sal:17,000p/m</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="item">
                      <div class="row">
                        <div class="col-sm-12">
                          <p>Arena has given me opportunities to grow as an artist and find my dream job. Arena
                            Animation Banashankari helped me build confidence about my skills & talent. Thank you for
                            Arena Banashankari and placements team.<span class="viewmore"><br><a href="#">View
                                more</a></span></p>
                          <span class="testioff"><strong class="testihed">Sunitha S </strong> – Working At Vinformax
                            Technologies Pvt Ltd, 3D Artist - Sal:15,000p/m </span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="item">
                      <div class="row">
                        <div class="col-sm-12">
                          <p>Of Course, Arena Banashankari is the best centre in Karnataka, I was blessed with well
                            trained faculties and management. Thanks for the excellent campus placements.<span
                              class="viewmore"><br><a href="#">View more</a></span></p>
                          <span class="testioff"><strong class="testihed">Lakshmipathy Reddy </strong> – Working At
                            Vinformax Technologies Pvt Ltd, VFX Compositor - Sal:15,000p/m</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="item">
                      <div class="row">
                        <div class="col-sm-12">
                          <p>As soon as I finished my course, I got a campus selection with Vinformax Technologies Pvt
                            Ltd, it was my dream to work such kind of MNC where I can learn and explore myself. Thanks
                            to Arena Banashankari and Placements team.<span class="viewmore"><br><a href="#">View
                                more</a></span></p>
                          <span class="testioff"><strong class="testihed">Vedant Chaturvedi </strong> – Working At
                            Vinformax Technologies Pvt Ltd, VFX Compositor - Sal:15,000p/m</span>
                        </div>
                      </div>
                    </div>

                  </div><!--carousel-inner ended here -->
                </div><!--carousel ended here -->
              </div>
            </div>
          </div><!--studspeakwrp ended here -->
        </div>
      </div>
    </div>
    ...
    <footer>
      <div class="ftr ftrText">
        <div class="container-fluid">
          <div class="col-md-10"><a href="index-2.html">Home</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a
              href="about-us.html">About Us</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a
              href="animation-courses.html">Courses</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a
              href="activities.html">Activities</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a
              href="careers.html">Careers</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp; <a
              href="students-works.html">Students Works</a>&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a
              href="faqs.html">Faqs</a> &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;<a href="contactus.html">Contact Us</a>
          </div>
          <div class="col-md-2" id="set-1">
            <div class="hi-icon-wrap hi-icon-effect-1 hi-icon-effect-1a">
              <a href="https://www.facebook.com/arenaanimation.bangalore" target="_blank"
                class="hi-icon hi-icon-mobile"><span class="fa fa-facebook-f"></span></a>
              <a href="javascript:void(0)" class="hi-icon hi-icon-screen"><span class="fa fa-linkedin"></span></a>
            </div>
          </div>
        </div>
      </div>
      <div class="ftryell">&copy; 1996 - 2023 - all rights reserved for SkyCode IT Solutions<div>
