...
<h1 class="wow fadeInDownBig">Mix Media</h1>
<div class="row mediawork">
<?php
                              $counter = 0;
                              $courses = $db->getRows("SELECT * from students_works_mix_media order by media_id desc");
                              if( count($courses) > 0){
                                foreach($courses as $data){ 
								  $design_id = $data["media_id"];
